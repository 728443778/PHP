<?php
return ['db' => ['dsn' => 'mysql:dbname=partner;host=127.0.0.1;port=3306',
        'username' => 'sa',
        'passwd' => '66666',
    ...
    'system' => [
        ...
        'valicode'=>[
            ...
            'width'=>75,           //验证码的宽度  ，不填写，默认
            'height'=>18,           //验证码的高度  ，不填写，默认
            'font'  =>'',           //验证码的字体路径  ，不填写，默认
            'fontsize'=>12,         //验证码的字体大小
            'dynamic'=>false,       //动态gif图片验证码
            'math'=>false,          //数学计算验证码
            ],
        'debug' => false,
        'template'=>[
            'errorlog'=>APPLICATION . DS . 'cache' .DS. 'error.log', //模板日志文件路径
        ],
        'name' => '全民经纪人', //站点名称
