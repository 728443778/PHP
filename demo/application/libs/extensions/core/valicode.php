...
class valicode
{
    ...
    */
    ...
    private static function createBg()
    {
        ...
        $color = imagecolorallocate(self::$img, mt_rand(230, 255), mt_rand(230, 255), mt_rand(230, 255));
    ...
    private static function createFont()
    {
        ...
        for ($i = 0; $i < self::$codelen; $i++) {
            self::$fontcolor = imagecolorallocate(self::$img, mt_rand(0, 30), mt_rand(0, 30), mt_rand(0, 30));
    ...
    {
        for ($i = 0; $i < 6; $i++) {
            $color = imagecolorallocate(self::$img, mt_rand(0, 40), mt_rand(0, 40), mt_rand(0, 40));
